...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
	...
	<xsl:template match="/ProductDetail">
		<section class="san-pham-ct van-san">
			<div class="container">
					...
					<div class="wrap-content-product padding-content">
						...
						<div class="content-main product-sku">
							...
							<div class="wrap-select-input options-wrap">
								...
								<ul>
									<li>
										<input type="radio" id="kichthuoc1" name="kichthuoc"/>
										<label for="kichthuoc1">12mm X 144mm X 1215mm</label>
									</li>
									<li>
										<input type="radio" id="kichthuoc2" name="kichthuoc"/>
						...
						<div class="wrap-order-button-1-line">
								...
								<a class='add-to-wishlist add-favorites' onclick="AjaxCart.addproducttowishlist(this);return false;">
									<xsl:if test="AddedWishList = 'True'">
										<xsl:attribute name="class">
											<xsl:text>add-to-wishlist add-favorites</xsl:text>
										</xsl:attribute>
						...
						<div class="col-lg-3">
							<xsl:if test="count(ProductOther) &gt; 0">
								<div class="wrap-other-product">
									...
									<div class="wrap-item">
										<xsl:apply-templates select="ProductOther" mode="cungdanhmuc"></xsl:apply-templates>
									</div>
								</div>
			...
			<section class="section home-product bg-grey">
				<div class="container">
					...
					<div class="wrapper-slide">
						<div class="swiper-container">
							<div class="swiper-wrapper">
								<xsl:apply-templates select="ProductOther" mode="sanPhamLienQuan"></xsl:apply-templates>
							</div>
							<div class="wrap-button">
	...
	<xsl:template match="ProductOther" mode="cungdanhmuc">
	...
	<xsl:template match="ProductOther" mode="sanPhamLienQuan">
		<div class="swiper-slide">
