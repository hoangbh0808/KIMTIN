                                    ...
                                    <div class="address-info clearfix">
                                        <div class="address-form clearfix">
                                            ...
                                            <div class="form-group check-group clearfix">
                                                <asp:CheckBox ID="chkIsDefault" Visible="false" Text="Sử dụng địa chỉ này làm mặc định" runat="server" />
                                            </div>
                                            <asp:Button ID="btnUpdate" ValidationGroup="AddressEdit" Text="Thêm mới" runat="server" />
