                            ...
                            <div class="row flex flex-wrap">
                                <div class="col-xs-12 col-md-6">
                                    <div class="account-info clearfix">
                                        ...
                                        <asp:HyperLink ID="lnkProfileEdit" runat="server" CssClass="link"
                                            Text="Chỉnh sửa"></asp:HyperLink>
                                ...
                                <div class="col-xs-12">
                                    <div class="cart-history clearfix">
                                        ...
                                        <asp:HyperLink ID="lnkAllOrders" runat="server" CssClass="link"
                                            Text="Xem tất cả"></asp:HyperLink>
                                ...
                                <div class="col-xs-12">
                                    <div class="address-info clearfix">
                                        ...
                                        <asp:HyperLink ID="lnkAddress" runat="server" CssClass="link" Text="Xem tất cả">
                                        </asp:HyperLink>
                                                    ...
                                                    <div class="address-col">
                                                        <div class="address default clearfix">
                                                            ...
                                                            <div class="addr-detail">
                                                                <ul>
                                                                    <li>Địa chỉ: <%#
                                                                            FormatAddress(Eval("Address").ToString(),
                                                                            Eval("ProvinceGuid").ToString(),
                                                                            Eval("DistrictGuid").ToString(),
                                                                            Eval("WardGuid").ToString())%>
                                                                    </li>
                                                                    <li>Điện thoại: <%#Eval("Phone")%>
                                                                    </li>
                                                                </ul>
                                                            </div>
