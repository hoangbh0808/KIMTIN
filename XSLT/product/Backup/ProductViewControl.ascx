...
<%@ Register Src="~/Product/Controls/ProductSoldOutletterControl.ascx" TagPrefix="Site" TagName="ProductSoldOutletterControl" %>
...
<asp:Panel ID="pnlInnerWrap" runat="server">
    ...
    <Site:ProductSoldOutletterControl runat="server" ID="productSoldOutletter" />
</asp:Panel>