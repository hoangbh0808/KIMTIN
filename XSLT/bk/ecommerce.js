...
$(document).ready(function () {
	...
	function getSlideIndexByClass(className, e) {
		var selector = ".product-detail-page ." + className + " .swiper-slide";
		var index = 0;
		$(selector).each(function (i) {
			if ($(this).attr("data-slide") == e) {
				index = i;
				return false;
			}
		});
	...
	function productSwiperInit() {
		...
		// 	var e = $(".swiper-product-main .swiper-slide-active").attr("data-slide");
		// 	$(".colour-wrapper a").removeClass("active");
		// 	$(".colour-wrapper a").each(function (i) {
		// 		if ($(this).attr("data-slide") == e) {
		...
		let productDetailThumbs = new Swiper(".product-slide-thumbs .swiper-container", {
			spaceBetween: 10,
			slidesPerView: 4,
		});
	
		let productDetailTop = new Swiper(".product-slide-top", {
			spaceBetween: 10,
			navigation: {
				nextEl: ".product-slide-thumbs .button-next",
				prevEl: ".product-slide-thumbs .button-prev",
			},
			thumbs: {
		...
		productDetailTop.on('slideChangeTransitionStart', function () {
			var e = $(".product-slide-top .swiper-slide-active").attr("data-slide");
			$(".colour-wrapper a").removeClass("active");
			$(".colour-wrapper a").each(function (i) {
				if ($(this).attr("data-slide") == e) {
					$(this).addClass("active");
		...
		$(".colour-wrapper a").click(function (def) {
			def.preventDefault();
			var e = $(this).attr("data-slide");
			var index = getSlideIndexByClass("product-slide-thumbs", e);
			// console.log("index: " + index);
			productDetailTop.slideTo(index);
	...
	function zoomImg() {
		if ($(window).width() > 1024) {
			$(".dt-product-detail .swiper-slide-active .zoom-img").ezPlus({
				gallery: "gallery_01",
				cursor: "pointer",
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success == true) {
                    ...
                    console.log($(AjaxCheckout.totalselector).html());
                }
            }
        });
    },
